...
func calcul_radacini(a: Float, b: Float, c: Float, x1_re: inout Float, x1_im: inout Float, x2_re: inout Float, x2_im: inout Float)
{
  print("a = \(a) b = \(b) c = \(c)")
  let delta = b * b - 4 * a * c
  if delta >= 0{
...
citeste(a:&a, b:&b, c:&c)
calcul_radacini(a: a, b: b, c: c, x1_re: &x1_re, x1_im: &x1_im, x2_re: &x2_re, x2_im: &x2_im)
